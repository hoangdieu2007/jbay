...
public class WonAuctionsController extends AuctionListControllerBase<BidderItemCardController> {
    ...
    protected ObservableMap<Integer, Auction> getAuctionMap() {
        return ClientSession.getInstance().getWonAuctions();
    }
    ...
    protected String getCreateCardErrorMessage() {
        return "Cannot create Winning card";
    }
}
