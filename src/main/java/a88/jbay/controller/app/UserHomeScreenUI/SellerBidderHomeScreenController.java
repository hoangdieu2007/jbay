...
public class SellerBidderHomeScreenController {
    ...
    private VBox createCardSeller(Auction auction) {
        try {
            ...
            loader.setLocation(getClass().getResource("/a88/jbay/view/app/AuctionUI/seller-item-card.fxml"));
            // load root node
    ...
    private VBox createCardBidder(Auction auction){
        try{
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/a88/jbay/view/app/AuctionUI/bidder-item-card.fxml"));
            // load root node
            VBox cardBox = loader.load();
