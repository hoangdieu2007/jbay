...
public class CurrentBiddingController extends AuctionListControllerBase<BidderItemCardController> {
    ...
    private boolean checkBidder(Auction auction) {
        return auction != null && auction.getSubscribers().contains(userID);
    }
}
